...
This repository is a **fork**: upstream [flare-foundation/go-flare](https://github.com/flare-foundation/go-flare)
...
a general-purpose fork of flare-foundation/go-flare.
...
* Go (version per `avalanchego/go.mod`)
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v1.11.0-ct.2`); a GitHub Release publishes the versioned images
